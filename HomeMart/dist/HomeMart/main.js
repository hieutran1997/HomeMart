...
var routes = [
    { path: 'login', component: _test_test_component__WEBPACK_IMPORTED_MODULE_2__["TestComponent"] },
];
...
var TestService = /** @class */ (function () {
    function TestService(http) {
        this.http = http;
        this.url = 'http://localhost:50595/api/home/';
    }
...
var TestComponent = /** @class */ (function () {
    ...
    TestComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.testService.getdata().subscribe(function (data) { _this.message = data; });
...
module.exports = __webpack_require__(/*! F:\BT.Home\HomeMart\src\main.ts */"./src/main.ts");
