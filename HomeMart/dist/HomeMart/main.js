...
var MatPaginatorIntlCro = /** @class */ (function (_super) {
    ...
    function MatPaginatorIntlCro() {
        ...
        _this.itemsPerPageLabel = 'Số sản phẩm';
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        var arrTemp = new Array({ Title: 'Trang chủ', url: '/' }, { Title: 'Khuyến mãi', url: '/chuong-trinh-khuyen-mai' });
...
module.exports = "<app-ngbd-carousel-config></app-ngbd-carousel-config>\r\n\r\n<div class=\"container\" style=\"margin-top: 20px;\">\r\n    <div class=\"row\">\r\n        <div class=\"col-lg-3\">\r\n            <mat-card>\r\n                <div *ngFor=\"let item of lstSideBar\">\r\n                    <span style=\"font-size: 15px;font-weight: bold;\">{{item.TenLoaiVatTu}}</span>\r\n                    <hr/>\r\n                    <ul>\r\n                        <li *ngFor=\"let subItem of item.ListNhomVatTu\">\r\n                            <a routerLink=\"/loai-hang/{{subItem.MANHOMVATTU}}\">{{subItem.TENNHOMVATTU}}</a>\r\n                        </li>\r\n                    </ul>\r\n                </div>\r\n                <div>\r\n                    <span style=\"font-size: 15px;font-weight: bold;\">Sản phẩm vừa xem</span>\r\n                    <hr/>\r\n                </div>\r\n            </mat-card>\r\n        </div>\r\n        <div class=\"col-lg-9\">\r\n            <app-content-home *ngIf=\"!isViewContent\"></app-content-home>\r\n            <app-category-details  *ngIf=\"isViewContent\"></app-category-details>\r\n        </div>\r\n    </div>\r\n</div>"
...
/* harmony import */ var _model_sideBarShowModel__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../model/sideBarShowModel */ "./src/app/model/sideBarShowModel.ts");
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(cookieService, commonService, route, location) {
        this.cookieService = cookieService;
        this.commonService = commonService;
        this.route = route;
        this.location = location;
    ...
    HomeComponent.prototype.getAllGroupMerchanedise = function () {
        ...
        this.commonService.getAllGroupMerchanedise().subscribe(function (res) {
            ...
            for (var i = 0; i < _this.lstLoaiVatTu.length; i++) {
                var temp = new _model_sideBarShowModel__WEBPACK_IMPORTED_MODULE_3__["sideBarShow"]();
...
var NgbdPopoverConfig = /** @class */ (function () {
    ...
    NgbdPopoverConfig.prototype.ngOnInit = function () {
        ...
        this.viewCartService.changeCart.subscribe(function (data) {
            _this.quantity = data.arrVatTuSelected.length;
...
var routes = [
    ...
    {
        path: 'dang-nhap',
        component: _layout_login_login_component__WEBPACK_IMPORTED_MODULE_7__["LoginComponent"]
    },
    {
        path: 'dang-ky',
        component: _layout_register_register_component__WEBPACK_IMPORTED_MODULE_8__["RegisterComponent"]
    }
];
...
var CommonServiceService = /** @class */ (function () {
    ...
    CommonServiceService.prototype.getDataPaging = function (event) {
        if (event) {
            return this._http.get(this.host + 'api/home/GetListMerchanedise?pagesize=' + event.pageSize + '&pagenumber=' + event.pageIndex);
        }
        else {
            return this._http.get(this.host + 'api/home/GetListMerchanedise?pagesize=6&pagenumber=1');
        }
    };
    CommonServiceService.prototype.getListMerchanediseByCategory = function (event, manhom) {
        if (event) {
            ...
            return this._http.get(this.host + 'api/home/GetListMerchanediseByCategory?pagesize=6&pagenumber=1&merchanedisetype=' + manhom);
        }
    };
    ...
    CommonServiceService.prototype.getListMerchanediseKhuyenMai = function (event) {
        if (event) {
            ...
            return this._http.get(this.host + 'api/home/GetListMerchanediseKhuyenMai?pagesize=6&pagenumber=1&makho=' + this.makho + '&madonvi=' + this.madonvi);
        }
    };
